  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 m-4">
        ...
        {mutation.data?.status == "fail" && (<StatusMessage type ="error" message={mutation.data?.messagae}/>)}
        {mutation.data?.status == "Success" && (<StatusMessage type ="success" message="Login Successfully"/>)}
        {/* Form for login */}
